...
public class AuthController {
  ...
  public ResponseEntity<?> login(@RequestBody LoginRequest request) {
    ...
    LoginUserPrincipal principal = (LoginUserPrincipal) userDetailsService.loadUserByUsername(
        request.getLoginId());
  ...
  public ResponseEntity<?> refresh(@RequestHeader("Authorization") String bearerToken,
    ...
    LoginUserDto loginUser = ((LoginUserPrincipal) userDetailsService.loadUserByUsername(
        loginId)).getLoginUser();
